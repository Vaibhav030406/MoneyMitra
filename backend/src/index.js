...
const BASE_PATH = env_config_1.Env.BASE_PATH || "/api/v1";
...
app.use(`${BASE_PATH}/transactions`, passport_config_1.passportAuthenticateJwt, transaction_routes_1.default);
app.use(errorHandler_middleware_1.errorHandler);
app.listen(env_config_1.Env.PORT, async () => {
    await (0, database_config_1.default)();
    console.log(`🚀 Server running on port ${env_config_1.Env.PORT}`);
});
